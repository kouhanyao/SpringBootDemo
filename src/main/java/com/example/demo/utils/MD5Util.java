...
package com.example.demo.MD5Util;
...
public class MD5Util {
    ...
    public static String Md5Password(String phone, String password) {
        return Md5Password(phone, "MD5PWD", password, 3);
    }
    ...
    public static String MD5(String val) {
        ...
        try {
            ...
            throw new RuntimeException("MD5 should not be supported!", var7);
        } catch (UnsupportedEncodingException var8) {
            throw new RuntimeException("UTF-8 should not be supported!", var8);
        }
    ...
    public static void main(String[] args) {
        String str = "123456";
        System.out.println(string2MD5(MD5(str).toUpperCase()));
    }

    public static String encryption(String str) {
        return string2MD5(string2MD5(str).toUpperCase());
    }
}
